...
export interface JobRequest { jobId?: string; idempotencyKey: string; projectId: string; operation: string; runClass: "exploratory" | "gate_check" | "formal" | "evolution_eval"; input: string; correlationId: string; outcome?: JobOutcome; }
