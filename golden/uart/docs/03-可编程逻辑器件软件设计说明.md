...
| 属性 | 内容 |
|---|---|
| 文档标识及版本 | UART-DOC-003 / v2.1 candidate |
...
设计对象为 GOLDEN-UART 项目的 UART 收发器 PLDS，顶层 `uart_top`，候选器件 `xc7k70tfbv676-1`，设计版本 v2.1 candidate，无发布号或批准基线。
...
| UART-DOC-001 | PLDS 研制任务书 v2.1 | candidate |
| UART-DOC-002 | PLDS 需求规格说明 v2.1 | candidate |
