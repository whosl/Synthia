/**
 * SHA-256（hex）。优先使用 WebCrypto；非安全上下文（无 crypto.subtle）退化为
 * 内联纯 JS 实现，保证批准表单在任何部署形态下都能生成 check_results_hash。
 */
...
/** 纯 JS SHA-256（FIPS 180-4），输入为 UTF-8 字节。导出以便单测。 */
